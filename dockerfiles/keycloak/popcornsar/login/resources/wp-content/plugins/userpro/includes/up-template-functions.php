...
add_action('up_profile_right_side', 'up_professional_nav', 40);

add_action('up_profile_right_side', 'up_professional_profile_info', 50);

add_action('up_profile_right_side', 'up_professional_after_right', 60);

add_action('up_profile_footer', 'up_professional_after', 10 );


function up_professional_profile_info()
{
    up_get_template_part('layout4/template/right-side/profile-info/info');
}

function up_professional_nav()
{
    up_get_template_part('layout4/template/right-side/navigation');
}
