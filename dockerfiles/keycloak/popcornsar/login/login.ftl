                                        ...
                                        <div class="vc_col-sm-6 wpb_column column_container   _ height-full">
                                                    ...
                                                    <div class="vc_column-inner vc_custom_1553503740950">
                                                        <div class="wpb_wrapper">
                                                            ...
                                                            <div class=""><input id="username" class="input318"
                                                                                 ...
                                                                                 type="text" autofocus
                                                                                 autocomplete="off"
                                                                                 placeholder="<#if !realm.loginWithEmailAllowed>${msg("Username")}<#elseif !realm.registrationEmailAsUsername>${msg("Username Or Email")}<#else>${msg("email")}</#if>"/>
                                                            </div>
                                                            </#if>
                                                                        <div class="clearboth"></div>
                                                                    </div>
                                            ...
                                            <div class="${properties.kcFormGroupClass!}">
                                                <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
                                                    <div class=" vc_custom_1553503689536">
                                                    ...
                                                    <div id="divider-13"
                                                         class="mk-divider     divider_full_width center thin_solid  ">
                                                        <div class="divider-inner"></div>
                                                    </div>
                                                    <div class="clearboth"></div>
                                                    <div class=" vc_custom_1553552607186">
                                                        <div id="text-block-14" class="mk-text-block   ">
                                                    <#if realm.resetPasswordAllowed>
                                                    <p><a class="subtitle02pop"
                                                    ...
                                                    <#--<a class="subtitle02pop" href="?page_id=829"><span class="pop02">회원가입 &gt;</span></a></p>-->
